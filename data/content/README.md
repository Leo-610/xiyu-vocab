...
当前线上规模：**538 义项**（A1 义项包 ∪ 专四 ∪ 专八，去重），有图 **537+**。

| 标签 | 义项数 | CSV | 配图 |
|------|--------|-----|------|
| 义项包 A1 | 79 | `data/batches/A1/words_senses_team.csv` | `data/images/A1/` |
| 专四 | 446 | `data/batches/exam/words_tem4.csv` | `data/images/tem4/` |
| 专八 | 59 | `data/batches/exam/words_tem8.csv` | `data/images/tem8/` |
