...
const PRESENT = {
  ...
  disculparse: ['me disculpo', 'te disculpas', 'se disculpa', 'nos disculpamos', 'os disculpáis', 'se disculpan'],
  doblar: ['doblo', 'doblas', 'dobla', 'doblamos', 'dobláis', 'doblan'],
  embarcar: ['embarco', 'embarcas', 'embarca', 'embarcamos', 'embarcáis', 'embarcan'],
  estacionar: ['estaciono', 'estacionas', 'estaciona', 'estacionamos', 'estacionáis', 'estacionan'],
  ...
  granizar: ['granizo', 'granizas', 'graniza', 'granizamos', 'granizáis', 'granizan'],
  ...
  probarse: ['me pruebo', 'te pruebas', 'se prueba', 'nos probamos', 'os probáis', 'se prueban'],
  prometer: ['prometo', 'prometes', 'promete', 'prometemos', 'prometéis', 'prometen'],
  rallar: ['rallo', 'rallas', 'ralla', 'rallamos', 'ralláis', 'rallan'],
